...
subroutine c_chxsec_lookuptable_calc(mxncomp_g, nrch_g, z_ar_g, bo_ar_g, traps_ar_g, tw_ar_g, twcc_ar_g,    &
    ...
    real(c_double), intent(in) :: so_lowerlimit_g
    ...
    real(c_double), dimension(mxncomp_g, nrch_g), intent(in) :: bo_ar_g 
    real(c_double), dimension(mxncomp_g, nrch_g), intent(in) :: traps_ar_g
    real(c_double), dimension(mxncomp_g, nrch_g), intent(in) :: tw_ar_g 
    real(c_double), dimension(mxncomp_g, nrch_g), intent(in) :: twcc_ar_g
    real(c_double), dimension(mxncomp_g, nrch_g), intent(in) :: mann_ar_g 
    real(c_double), dimension(mxncomp_g, nrch_g), intent(in) :: manncc_ar_g
    ...
    real(c_double), dimension(11, nrow_chxsec_lookuptable, mxncomp_g, nrch_g), intent(out) :: chxsec_lookuptable
    real(c_double), dimension(mxncomp_g, nrch_g), intent(out) :: z_adj   
