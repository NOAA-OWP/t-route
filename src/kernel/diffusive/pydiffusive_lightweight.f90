...
subroutine c_compute_diffusive_couplingtimestep(timestep_ar_g, nts_ql_g, nts_db_g, nts_qtrib_g, nts_da_g,                &
                                                ...
                                                q_next_out_time, elv_next_out_time, depth_next_out_time) bind(c)      
    ...
    real(c_double), dimension(mxncomp_g,   nrch_g),          intent(in) :: inidepth
    ...
    real(c_double), dimension(mxncomp_g, nrch_g),            intent(in) :: z_adj
    real(c_double), dimension(11, nrow_chxsec_lookuptable, mxncomp_g, nrch_g), intent(in) :: chxsec_lookuptable
    real(c_double), dimension(mxncomp_g, nrch_g), intent(out) :: q_next_out_time
    real(c_double), dimension(mxncomp_g, nrch_g), intent(out) :: elv_next_out_time
    real(c_double), dimension(mxncomp_g, nrch_g), intent(out) :: depth_next_out_time
