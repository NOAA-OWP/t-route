...
def set_supernetwork_parameters(
    ...
    if supernetwork not in supernetwork_options:
        ...
        return {
            "geo_file_path": str(pathlib.Path(
            ...
            "waterbody_parameter_file_path": str(pathlib.Path(
        ...
        rv.update(
            {
                ...
                "mask_file_path": str(pathlib.Path(
                    geo_input_folder,
                    "Channels",
                    "masks",
        ...
        # return {
        #'geo_file_path' : str(pathlib.Path(geo_input_folder
    # , r'PoconoSampleData2'
    ...
    # }
        ...
        custominput = str(pathlib.Path(geo_input_folder).resolve())
