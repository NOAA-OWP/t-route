...
def build_run_sets(network, supernetwork_parameters, forcing_parameters, compute_parameters, 
                   data_assimilation_parameters, output_parameters, parity_parameters):
