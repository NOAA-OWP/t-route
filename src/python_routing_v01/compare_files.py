...
# print(sys.path)
result_sseg2, result_sseg_v02_2 = cfu.pr_check(root_folder_PR2)

if result_sseg1 == result_sseg2:
    print("PASS - results of compute_nhd_routing_SingleSeg.py are equal")
else:
    print("FAIL - results of compute_nhd_routing_SingleSeg.py are not equivalent")

if result_sseg_v02_1 == result_sseg_v02_2:
    print("PASS - results of compute_nhd_routing_SingleSeg_v02.py are equal")
else:
    print("FAIL - results of compute_nhd_routing_SingleSeg_v02.py are not equivalent")
