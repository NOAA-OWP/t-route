...
# Set DA values
# usgs_df
full_model.set_value('timeslice_discharge', np.array([1,2,3,4,5,6]))
full_model.set_value('timeslice_stationId', np.array(['01012570', '01013500', '01012515', '01012570', '01013500', '01012515']))
full_model.set_value('timeslice_time', np.array(['2015-08-16_00:00:00','2015-08-16_00:03:00','2015-08-16_00:03:00',
                                                '2015-08-16_00:15:00', '2015-08-16_00:18:00','2015-08-16_00:18:00']))
full_model.set_value('timeslice_discharge_quality', np.array([100,100,100,100,100,100]))
...
for hr in range(120):
    ...
    #model_start_date= 
    #rfc_timeseries_offset_hours =  self._waterbody_parameters['rfc']['reservoir_rfc_operation_type']
    #rfc_gage_id =  values['rfc_gage_id'][0]
    #rfc_timeseries_folder = self._waterbody_parameters['rfc']['reservoir_rfc_forecasts_time_series_path']
    #lake_number
    #routing_period
    #self._waterbody_parameters['rfc']['reservoir_rfc_timeseries_search_lookback_hours']
